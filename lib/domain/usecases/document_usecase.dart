...
class DocumentUseCase {
  ...
  DocumentUseCase(this._documentRepository, this._errorHandler);
  ...
  Future<Document?> getDocumentById(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentById');
      return null;
    }
  }
  ...
  Future<List<Document>> getDocumentsByCourseId(String courseId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentsByCourseId');
      return [];
    }
  }
  ...
  Future<List<Document>> getDocumentsByChapterId(String chapterId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentsByChapterId');
      return [];
    }
  }
  ...
  Future<List<Document>> getDocumentsByFormat(String format) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentsByFormat');
      return [];
    }
  }
  ...
  Future<void> updateDocumentProgress(String documentId, int currentPage, double progress) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.updateDocumentProgress');
      rethrow;
    }
  }
  ...
  Future<void> markDocumentAsCompleted(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.markDocumentAsCompleted');
      rethrow;
    }
  }
  ...
  Future<void> updateDocumentReadingPosition(String documentId, int page, int position) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.updateDocumentReadingPosition');
      rethrow;
    }
  }
  ...
  Future<String?> getDocumentContent(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentContent');
      return null;
    }
  }
  ...
  Future<void> saveDocumentContent(String documentId, String content) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.saveDocumentContent');
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> getDocumentMetadata(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentMetadata');
      return {};
    }
  }
  ...
  Future<void> updateDocumentMetadata(String documentId, Map<String, dynamic> metadata) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.updateDocumentMetadata');
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getDocumentReadingHistory(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentReadingHistory');
      return [];
    }
  }
  ...
  Future<void> addDocumentReadingRecord(String documentId, int page, int position, Duration readingTime) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.addDocumentReadingRecord');
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>> getDocumentStatistics(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentStatistics');
      return {};
    }
  }
  ...
  Future<List<Document>> searchDocuments(String query, {String? courseId, String? chapterId}) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.searchDocuments');
      return [];
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getDocumentBookmarks(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentBookmarks');
      return [];
    }
  }
  ...
  Future<void> addDocumentBookmark(String documentId, int page, String note) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.addDocumentBookmark');
      rethrow;
    }
  }
  ...
  Future<void> removeDocumentBookmark(String documentId, String bookmarkId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.removeDocumentBookmark');
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getDocumentAnnotations(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentAnnotations');
      return [];
    }
  }
  ...
  Future<void> addDocumentAnnotation(String documentId, int page, String annotation) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.addDocumentAnnotation');
      rethrow;
    }
  }
  ...
  Future<void> removeDocumentAnnotation(String documentId, String annotationId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.removeDocumentAnnotation');
      rethrow;
    }
  }
  ...
  Future<void> refreshDocumentData(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.refreshDocumentData');
      rethrow;
    }
  }
  ...
  Future<void> clearDocumentCache(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.clearDocumentCache');
      rethrow;
    }
  }
  ...
  Future<String?> downloadDocument(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.downloadDocument');
      return null;
    }
  }
  ...
  Future<bool> isDocumentAvailable(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.isDocumentAvailable');
      return false;
    }
  }
  ...
  Future<int?> getDocumentSize(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentSize');
      return null;
    }
  }
  ...
  Future<DateTime?> getDocumentLastModified(String documentId) async {
    try {
      ...
      _errorHandler.handleError(e, context: 'DocumentUseCase.getDocumentLastModified');
      return null;
    }
  }
}
